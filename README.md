<svg width="1200" height="300" viewBox="0 0 1200 300" xmlns="http://www.w3.org/2000/svg">
  ...
  <!-- Dashed line -->
  <line x1="250" y1="150" x2="950" y2="150" stroke="#00eaff" stroke-width="2" stroke-dasharray="8 10" opacity="0.6"/>

  <!-- ================= SHIELD (Encryption Point) ================= -->
  ...
  <g transform="translate(950 150)" filter="url(#glow)">
    ...
    <rect x="-30" y="-35" width="60" height="12" rx="2" fill="none" stroke="#00eaff" stroke-width="2"/>
    <rect x="-30" y="-15" width="60" height="12" rx="2" fill="none" stroke="#00eaff" stroke-width="2"/>
    <rect x="-30" y="5" width="60" height="12" rx="2" fill="none" stroke="#00eaff" stroke-width="2"/>
  ...
  <g font-family="monospace" font-size="22" font-weight="bold" fill="#00eaff" text-anchor="middle">
    ...
    <text y="150" fill="#00eaff">
      *
      <animate attributeName="x" values="560;950" dur="2s" repeatCount="indefinite" begin="2s"/>
      <animate attributeName="opacity" values="0;1" dur="2s" repeatCount="indefinite" begin="2s"/>
    </text>

    <!-- Digit 2 -->
    <text y="155" fill="#00eaff">
      2
    ...
    <text y="155" fill="#00eaff">
      #
      <animate attributeName="x" values="580;970" dur="2s" repeatCount="indefinite" begin="2s"/>
      <animate attributeName="opacity" values="0;1" dur="2s" repeatCount="indefinite" begin="2s"/>
    </text>

    <!-- Digit 3 -->
    <text y="145" fill="#00eaff">
      3
    ...
    <text y="145" fill="#00eaff">
      @
      <animate attributeName="x" values="600;990" dur="2s" repeatCount="indefinite" begin="2s"/>
      <animate attributeName="opacity" values="0;1" dur="2s" repeatCount="indefinite" begin="2s"/>
    </text>
    ...
    <text y="150" fill="#00eaff">
      8
      <animate attributeName="x" values="620;1010" dur="2s" repeatCount="indefinite" begin="2s"/>
      <animate attributeName="opacity" values="0;1" dur="2s" repeatCount="indefinite" begin="2s"/>
    </text>
